...
public interface ExhortoForaneoMigracionRepository extends JpaRepository<ExhortoForaneoMigracion, Integer> {
    List<ExhortoForaneoMigracion> findByJuzgado(String juzgado);

    List<ExhortoForaneoMigracion> findByNumeroAndAmoAndJuzgado(String expediente, Integer amo, String juzgado);
}
