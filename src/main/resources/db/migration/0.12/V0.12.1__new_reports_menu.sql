...
ALTER TABLE TRIALS.TBL_DOMICILIOS ADD COLUMN S_MUNICIPIO_ID VARCHAR(10) NULL;
ALTER TABLE TRIALS.TBL_ESCOLARIDADES ADD COLUMN CLAVE_REPORTE INT;
ALTER TABLE TRIALS.TBL_PERSONA_DETALLE ADD COLUMN N_POSICION_TRABAJO INT NULL;