...
class DocumentoFoliosRepositoryTest extends AuditConfigTest {
        ...
        void getFolioOficioJuzgado() {
                ...
                Optional<DocumentoFolios> documentoFolios = documentoFolioRepository
                                .findByCentroTrabajoAndTipoDocumento(juzgado.getId(), TipoCentroTrabajo.JUZGADO,
        ...
        void getFolioOficioOficialia() {
                oficialia = oficialiaRepository.findAll().stream()
                                .filter(of -> of.getTipoOficialia().getNombre().equals("Común")).findFirst()
                                .orElseThrow();
                Optional<DocumentoFolios> documentoFolios = documentoFolioRepository
                                .findByCentroTrabajoAndTipoDocumento(oficialia.getId(),
                                                TipoCentroTrabajo.OFICIALIA_COMUN, TipoDocumento.OFICIO);
