...
class MovimientosResourceTest {
        ...
        public void setUp() {
                ...
                movimiento = new MovimientoSalidaRecord(uuid, TipoCarpeta.DEMANDA, "1", "00001/2024",
                                LocalDateTime.now(),
                                "Juzgado 1", null, "dasd", null, "expediente", "nombre", "persona", "observacion", 1,
                                null, anexos);
        }
        ...
        void crearMotivoErrorTest() throws Exception {
                ...
                willThrow(new RuntimeException("Error al crear el motivo")).given(movimientoService)
                                .createMotivo(motivoRecord);
