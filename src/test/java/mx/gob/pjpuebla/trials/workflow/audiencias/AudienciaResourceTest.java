...
class AudienciaResourceTest {
        ...
        void getAllAudienciasGenerales() throws Exception {
                AudienciasGeneralesResponseRecord audienciaRecord = AudienciaSetUp
                                .createAudienciasGeneralesResponseRecord();
        ...
        void getAudienciasMotivos() throws Exception {
                ...
                mockMvc.perform(get("/api/workflow/audiencias/motivos")
                                ...
                                .andExpect(jsonPath("$[0].etiqueta")
                                                .value("La parte actora no llegó con la oportunidad solicitada"))
                                .andExpect(jsonPath("$.length()")
                                                .value(CatalogoMotivosRetrasoAudiencias.values().length));
        }
        ...
        void reprogramarAudiencia_success() throws Exception {
                ...
                mockMvc.perform(patch("/api/workflow/bandeja/audienciasgenerales/reprogramar")
                                ...
                                .content(ResourceUtilTest
                                                .asJsonString(AudienciaSetUp.createReprogramarAudienciaRecord())))
                                .andExpect(status().isOk());
        }
