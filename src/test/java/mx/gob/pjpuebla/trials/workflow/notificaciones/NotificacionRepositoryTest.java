...
class NotificacionRepositoryTest extends AuditConfigTest {
        ...
        void testGetNotificacionByTipo() {
                ...
                juzgado.setId(51);
                List<Juzgado> juzgados = List.of(juzgado);

                Page<Notificacion> result = notificacionRepository.getNotificacionByTipo(tipo, estado,
                                PageRequest.of(0, 20),
                                juzgados);
        ...
        void testFindDocumentoDetalleByDocumentoId() {
                ...
                List<DocumentoDetalleRecord> result = notificacionRepository
                                .findDocumentoDetalleByDocumentoId(documentoId);
        ...
        void testFindNotificacionesTurnado() {
                ...
                assertThat(notificaciones)
                                .isNotNull()
                                .isNotEmpty()
                                .allMatch(notificacion -> (notificacion
                                                .getTipoNotificacion() == TipoNotificacion.ESTRADO
