...
class NotificacionResourceTest {
        ...
        void acuerdoNotificaciones_success() throws Exception {
                PageImpl<AcuerdoNotificacionesRecord> page = new PageImpl<>(
                                Collections.singletonList(NotificacionSetUp.acuerdoNotificacionesRecord()));
        ...
        void getFile_ShouldReturnPdfFile() throws Exception {
                ...
                mockMvc.perform(MockMvcRequestBuilders.get("/api/workflow/bandeja/notificaciones/{notificacionId}/file",
                                notificacionId))
