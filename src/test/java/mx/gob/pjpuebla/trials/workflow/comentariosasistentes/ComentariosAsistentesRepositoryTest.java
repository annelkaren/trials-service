...
@Sql(value = {
        ...
        "/scripts/INSERT_COMENTARIOS_ASISTENTES.sql",
}, executionPhase = Sql.ExecutionPhase.BEFORE_TEST_CLASS)
@Sql(value = {
        "/scripts/DELETE_COMENTARIOS_ASISTENTES.sql",
...
class ComentariosAsistentesRepositoryTest extends AuditConfigTest {

    @Autowired
    private ComentariosAsistentesRepository comentariosAsistentesRepository;

    @Test
    void findByPersonaDocumentoId_returnsNotNullResult() {
        Page<ComentariosAsistentes> result = comentariosAsistentesRepository.findByPersonaDocumentoId(
