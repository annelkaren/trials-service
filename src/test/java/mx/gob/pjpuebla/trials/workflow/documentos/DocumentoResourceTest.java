...
class DocumentoResourceTest {
        ...
        void getAllHistorial() throws Exception {
                ...
                BandejaHistorialRecord documentoGridRecord = new BandejaHistorialRecord(null, folio, expediente,
                                materiaNombre, tipoEntrada, null, estatus, tipoEntrada, materiaNombre);
        ...
        void getAll_bandeja_salida_success() throws Exception {
                ...
                given(documentoService.getAllBandejaSalida(anyString(), anyString(), anyString(), anyString(),
        ...
        void movimientoPersonalJuzgado_success() throws Exception {
                ...
                List<PersonalJuzgadoRecord> personalJuzgadoRecords = List
                                .of(new PersonalJuzgadoRecord(51, 2, "DEMANDA", 3));
                ...
                mockMvc.perform(
                                post("/api/workflow/bandeja/recepcion/movimiento")
                                                .content(ResourceUtilTest.asJsonString(personalJuzgadoRecords)) // Ahora
                                                                                                                // enviamos
                                                                                                                // una
                                                                                                                // lista
                                                .contentType(MediaType.APPLICATION_JSON)
        ...
        void turnadoPersonalJuzgado_success() throws Exception {
                AsignadoTurnadoRecord asignadoTurnadoRecord = new AsignadoTurnadoRecord(52, 150, 1, 7,
                                Prioridad.NORMAL);
                List<AsignadoTurnadoRecord> records = Collections.singletonList(asignadoTurnadoRecord);
                List<MovimientoPersonalJuzgadoRecord> mockResponse = Collections
                                .singletonList(DocumentoSetUp.createMovimientoPersonalJuzgadoRecord());
        ...
        void create_demanda_antigua() throws Exception {
                ...
                given(documentoService.createDemandaAntigua(any(DocumentoAntiguoSaveRecord.class),
                ...
                verify(documentoService).createDemandaAntigua(any(DocumentoAntiguoSaveRecord.class),
                                any(MultipartFile.class));
        }
        ...
        void getExhortoById() throws Exception {
                ...
                given(documentoService.getExhortoById(1)).willReturn(
                                new ExhortoResponseRecord(anexos, "Obeservaciones", "Procedencia", "Exhorto"));
        ...
        void createExhortoSalida() throws Exception {
                ...
                DocumentoPromocionResponseRecord expectedResponse = new DocumentoPromocionResponseRecord(1, "12345",
                                TipoDocumento.EXHORTO_SALIDA);
                given(documentoService.createExhortoSalida(any(DocumentoExhortoSalidaRecord.class),
                                any(MultipartFile.class)))
                                .willReturn(expectedResponse);
        ...
        void testAdjuntarPromocion() throws Exception {
                DocumentoPromocionResponseRecord responseRecord = new DocumentoPromocionResponseRecord(10, "1",
        ...
        void getAmparoById_Found() throws Exception {
                ...
                mockMvc.perform(get("/api/workflow/documentos/amparo/{id}", 1)
                                ...
                                .andExpect(jsonPath("$.carpetaId").value(52)) // Verifica el id de la carpeta en la
                                                                              // respuesta
