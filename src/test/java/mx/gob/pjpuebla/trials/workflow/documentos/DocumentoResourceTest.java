...
class DocumentoResourceTest {
        ...
        void getAll() throws Exception {
                ...
                DocumentoGridRecord documentoGridRecord = new DocumentoGridRecord(1, demanda.getCarpeta().getFolio(),
                                ...
                                "Laboral", TipoDocumento.DEMANDA.name(), LocalDateTime.now(), SelloEstatus.VALIDO,
                                true);
        ...
        void edit_anexos() throws Exception {
                ...
                DocumentoRecord documentoRecord = new DocumentoRecord(1, "000001/2024", TipoDocumento.DEMANDA);
        ...
        void getEditDocumento() throws Exception {
                ...
                DocumentoRecord documentRecord = new DocumentoRecord(1, "000005/2024", TipoDocumento.DEMANDA);
