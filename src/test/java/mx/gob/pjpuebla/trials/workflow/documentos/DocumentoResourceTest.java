...
class DocumentoResourceTest {
    ...
    void getAllAsignados() throws Exception {
        ...
        DocumentoAsignadoResponseRecord documentoRecord = new DocumentoAsignadoResponseRecord(1, 1, 1, expediente, folio, expediente, expediente, LocalDateTime.now(), LocalDateTime.now(), folio, expediente, true, "prorroga", EstadoProrroga.AUTORIZADA);
