...
class MovimientosRepositoryTest extends AuditConfigTest {
        ...
        void getAllBandejaRecepcion() {
                ...
                Page<DocumentoBandejaRecepcionRecord> page = movimientoRepository.getBandejaRecepcionPage(
                                PageRequest.of(0, 20),
                                juzgadoId, estados, persona, false, motivo, motivosTurnado, key, cmdLetra, cmdFolio,
                                folio, expediente,
                                tipoEntrada, origen, motivo, fechaFrom, fechaTo, userJuzgadoNombre,
                                userOficialiaNombre);
