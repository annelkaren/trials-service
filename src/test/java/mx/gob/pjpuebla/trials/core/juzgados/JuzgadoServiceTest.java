...
class JuzgadoServiceTest {
        ...
        void getAll_return_page() {
                ...
                Page<JuzgadoRecordItem> page = juzgadoService.getAll(key, "", "", Estado.ACTIVE,
                ...
                assertThat(page.getContent())
                                ...
                                .hasFieldOrPropertyWithValue("materia", StringUtils.capitalize(StringUtils
                                                .stripAccents(juzgado.getMateria().getNombre()).toLowerCase()));
        }
        ...
        void actualizar_carga() {
                ...
                given(juzgadoRepository.findJuzgadosMenosAsignaciones(any(Materia.class), any(InstanciaJuzgado.class),
                                Mockito.eq(idsSimulados)))
                ...
                verify(juzgadoRepository, times(1)).findJuzgadosMenosAsignaciones(any(Materia.class),
                                any(InstanciaJuzgado.class), Mockito.eq(idsSimulados));
        ...
        void get_juzgado_aleatorio() {
                ...
                given(juzgadoRepository.findJuzgadosMenosAsignaciones(any(Materia.class), any(InstanciaJuzgado.class),
                                any())).willReturn(juzgadoApelacion);
                TipoCarpeta tipoApelacion = TipoCarpeta.APELACION;
        ...
        void getSalas() {
                ...
                List<JuzgadoRecordItem> salas = Collections.singletonList(
                                new JuzgadoRecordItem(sala.getId(), sala.getNombre(), sala.getEstado(),
                                                sala.getSede().getNombre()));
        ...
        void juzgadoActual() {
                ...
                JuzgadoRecordItem juzgadoActual = new JuzgadoRecordItem(juzgado.getId(), juzgado.getNombre(),
                                juzgado.getEstado(), juzgado.getNombre());
