...
class TipoAudienciaRepositoryTest extends AuditConfigTest {
        ...
        void testFindByNombre() {
                TipoAudiencia tipoAudiencia = tipoAudienciaRepository
                                .findByNombre("Junta de avenencia y contestación de demanda");
        ...
        void testFindByMateria() {
                ...
                materia.setId(200);
                Page<TipoAudiencia> tipoAudiencia = tipoAudienciaRepository.findByMateriaAndNombreContainingIgnoreCase(
                                materia,
                                "Conciliación", PageRequest.of(0, 10));
        ...
        void testFindByMateriaAndTipoSistema() {
                ...
                Page<TipoAudiencia> tipoAudiencia = tipoAudienciaRepository
                                .findByMateriaAndTipoSistemaAndNombreContainingIgnoreCase(materia, tipoSistema,
                                                "Aprobación de Convenio", PageRequest.of(0, 10));
                assertThat(tipoAudiencia.getContent()).isNotEmpty();
        }
