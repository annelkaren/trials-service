...
class DerechosHumanosResourceTest {
    ...
    @BeforeEach
    void setUp() {
        derechosHumanosRecord = new DerechosHumanosRecord(1, "Libertad de tránsito y residencia (Derecho a la)",
                TipoDerechosHumanos.DERECHOS_PERSONA);
    }

    @Test
    void getListByTipo_success() throws Exception {
        given(derechosHumanosService.getListByTipo("DERECHOS_PERSONA"))
                .willReturn(Collections.singletonList(derechosHumanosRecord));
