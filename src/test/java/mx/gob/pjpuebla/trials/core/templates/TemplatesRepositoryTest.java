...
@Sql(value = {
                ...
                "/scripts/INSERT_TEMPLATES.sql",
}, executionPhase = Sql.ExecutionPhase.BEFORE_TEST_CLASS)
@Sql(value = {
                "/scripts/DELETE_TEMPLATES.sql",
...
class TemplatesRepositoryTest extends AuditConfigTest {
        ...
        void findByJuzgadoId() {
                List<Templates> templates = templatesRepository.findByJuzgadoId(52);
